...
mod tests {
    ...
    fn sample_candles() -> Vec<Candle> {
        ...
        vec![
            Candle::new(10.0, 11.0, 9.0, 10.0, 1000.0),
            Candle::new(11.0, 12.0, 10.0, 11.0, 1000.0),
            Candle::new(12.0, 13.0, 11.0, 12.0, 1000.0),
            Candle::new(13.0, 14.0, 12.0, 13.0, 1000.0),
            Candle::new(14.0, 15.0, 13.0, 14.0, 1000.0),
        ]
    }
    ...
    fn trending_up_candles() -> Vec<Candle> {
        ...
        vec![
            Candle::new(100.0, 102.0, 98.0, 100.0, 1000.0),
            Candle::new(103.0, 107.0, 102.0, 105.0, 1000.0),
            Candle::new(106.0, 112.0, 105.0, 110.0, 1000.0),
            Candle::new(111.0, 117.0, 110.0, 115.0, 1000.0),
            Candle::new(116.0, 122.0, 115.0, 120.0, 1000.0),
            Candle::new(121.0, 128.0, 120.0, 126.0, 1000.0),
            Candle::new(127.0, 135.0, 126.0, 133.0, 1000.0),
            Candle::new(134.0, 143.0, 133.0, 141.0, 1000.0),
        ]
    }
